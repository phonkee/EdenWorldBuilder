...
const int blockinfo[NUM_BLOCKS+1]={
    ...
    [TYPE_PORTAL1]=IS_OBJECT|IS_PORTAL,
    [TYPE_PORTAL2]=IS_OBJECT|IS_PORTAL,
    [TYPE_PORTAL3]=IS_OBJECT|IS_PORTAL,
    [TYPE_PORTAL4]=IS_OBJECT|IS_PORTAL,
    [TYPE_PORTAL_TOP]=IS_OBJECT|IS_PORTAL,
    [TYPE_GOLDEN_CUBE]=IS_NOTSOLID|IS_OBJECT,
    [TYPE_FLOWER]=IS_NOTSOLID|IS_OBJECT,
    [TYPE_LIGHTBOX]=0,
    [TYPE_CUSTOM]=IS_NOTSOLID,
	[TYPE_TNT]=IS_FLAMMABLE|IS_COLOREDSPECIAL,
    [TYPE_FIREWORK]=IS_FLAMMABLE|IS_COLOREDSPECIAL,
	[TYPE_BRICK]=IS_COLOREDSPECIAL,
    [TYPE_STEEL]=0,
	[TYPE_COBBLESTONE]=0,
	[TYPE_ICE]=IS_ICE,
	[TYPE_CRYSTAL]=0,
    ...
    [TYPE_VINE]=0,
    [TYPE_WEAVE]=IS_FLAMMABLE|IS_NOTSOLID|IS_ATLAS2,
    [TYPE_SHINGLE]=0,
    [TYPE_GLASS]=IS_NOTSOLID|IS_ATLAS2,
    [TYPE_GRADIENT]=0,
    
    
    [TYPE_STONE_RAMP1]=IS_NOTSOLID|IS_RAMP|IS_RAMPORSIDE,
    [TYPE_STONE_RAMP2]=IS_NOTSOLID|IS_RAMP|IS_RAMPORSIDE,
    [TYPE_STONE_RAMP3]=IS_NOTSOLID|IS_RAMP|IS_RAMPORSIDE,
    [TYPE_STONE_RAMP4]=IS_NOTSOLID|IS_RAMP|IS_RAMPORSIDE,
    ...
    [TYPE_STONE_SIDE1]=IS_NOTSOLID|IS_SIDE|IS_RAMPORSIDE,
    [TYPE_STONE_SIDE2]=IS_NOTSOLID|IS_SIDE|IS_RAMPORSIDE,
    [TYPE_STONE_SIDE3]=IS_NOTSOLID|IS_SIDE|IS_RAMPORSIDE,
    [TYPE_STONE_SIDE4]=IS_NOTSOLID|IS_SIDE|IS_RAMPORSIDE,
    
    [TYPE_SHINGLE_SIDE1]=IS_NOTSOLID|IS_SIDE|IS_RAMPORSIDE,
    [TYPE_SHINGLE_SIDE2]=IS_NOTSOLID|IS_SIDE|IS_RAMPORSIDE,
    [TYPE_SHINGLE_SIDE3]=IS_NOTSOLID|IS_SIDE|IS_RAMPORSIDE,
    [TYPE_SHINGLE_SIDE4]=IS_NOTSOLID|IS_SIDE|IS_RAMPORSIDE,
    ...
    [TYPE_WOOD_SIDE1]=IS_FLAMMABLE|IS_NOTSOLID|IS_SIDE|IS_RAMPORSIDE,
    [TYPE_WOOD_SIDE2]=IS_FLAMMABLE|IS_NOTSOLID|IS_SIDE|IS_RAMPORSIDE,
    [TYPE_WOOD_SIDE3]=IS_FLAMMABLE|IS_NOTSOLID|IS_SIDE|IS_RAMPORSIDE,
    [TYPE_WOOD_SIDE4]=IS_FLAMMABLE|IS_NOTSOLID|IS_SIDE|IS_RAMPORSIDE,
    
	
};
const GLubyte creatureColor[NUM_CREATURES+1][3]={
    [M_MOOF]={70,70,255},
    [M_GREEN]={115,206,74},
    [M_NERGLE]={255,70,255},
    [M_BATTY]={255,70,255},
...
const GLubyte blockColor[NUM_BLOCKS+1][3]={
	[TYPE_NONE]={0},
	[TYPE_BEDROCK]={90,90,90},
	[TYPE_DARK_STONE]={200,200,200},
...
const int blockTypeFaces[NUM_BLOCKS+1][6]={
	[TYPE_NONE]={0},
