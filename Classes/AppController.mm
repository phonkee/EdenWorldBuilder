...
- (void) applicationDidFinishLaunching:(UIApplication*)application
{
	...
	for(;;)
	{
		...
		int iMSAA = pPVRShell->PVRShellGet(prefFSAAMode);
		...
		_glView = [[EAGLView alloc] initWithFrame:rect pixelFormat:strColourFormat depthFormat:iDepthFormat stencilFormat:iStencilFormat preserveBackbuffer:NO scale:scale msaaMaxSamples:2*iMSAA];	// i.e. 1,2,4 for MSAA
